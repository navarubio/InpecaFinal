...
public class TipocuentacontableController implements Serializable {
    ...
    public void create() {
        persist(PersistAction.CREATE, ResourceBundle.getBundle("/bundle.actual").getString("TipocuentacontableCreated"));
    ...
    public void update() {
        persist(PersistAction.UPDATE, ResourceBundle.getBundle("/bundle.actual").getString("TipocuentacontableUpdated"));
    }

    public void destroy() {
        persist(PersistAction.DELETE, ResourceBundle.getBundle("/bundle.actual").getString("TipocuentacontableDeleted"));
        if (!JsfUtil.isValidationFailed()) {
